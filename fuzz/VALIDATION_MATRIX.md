...
This matrix records the current fuzz target, deterministic seed corpus, golden or vector coverage, and the remaining readiness item for each storage-critical or protocol-critical surface.
...
- `fuzz/fuzz_targets/proto_rpc_execute_request_decode.rs`
- `fuzz/fuzz_targets/proto_invocation_response_sequence_decode.rs`
- `fuzz/fuzz_targets/quic_typed_frame_envelope_decode.rs`
- `fuzz/fuzz_targets/rpc_protocol_frame_codec_decode.rs`
- `fuzz/fuzz_targets/security_contract_admission_matrix.rs`
