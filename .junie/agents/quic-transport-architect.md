---
name: quic-transport-architect
description: Owns QUIC surfaces, streams, flow control, backpressure, session behavior, and RPC dispatch boundaries. Use for network surface, stream mapping, backpressure, connection lifecycle, and transport errors.
...
Owns QUIC surfaces, streams, flow control, backpressure, session behavior, and RPC dispatch boundaries.

## Use this agent when

Use for network surface, stream mapping, backpressure, connection lifecycle, and transport errors.
