...
description: Designs workspace layout, crate boundaries, features, and build profiles. Use for Rust project structure, Cargo workspace, module dependencies, and tooling.
...
Designs workspace layout, crate boundaries, features, and build profiles.

## Use this agent when

Use for Rust project structure, Cargo workspace, module dependencies, and tooling.
