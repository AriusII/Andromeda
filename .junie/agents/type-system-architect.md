...
description: Owns scalar types, decimals, floats, text, enums, flags, nullability, StructuredObjects, and type contracts. Use for type policy, SRPL type binding, and contract-level type compatibility.
...
Owns scalar types, decimals, floats, text, enums, flags, nullability, StructuredObjects, and type contracts.

## Use this agent when

Use for type policy, SRPL type binding, and contract-level type compatibility.
