---
name: srpl-language-designer
description: Designs SRPL syntax and user-facing semantics. Use for SRPL syntax, cardinality, errors, procedure shape, and language restrictions.
...
Designs SRPL syntax and user-facing semantics.

## Use this agent when

Use for SRPL syntax, cardinality, errors, procedure shape, and language restrictions.
