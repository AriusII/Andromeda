...
description: Owns unit, integration, fuzz, property, crash, and recovery test plans. Use for acceptance criteria, automated tests, and verification matrices.
...
Owns unit, integration, fuzz, property, crash, and recovery test plans.

## Use this agent when

Use for acceptance criteria, automated tests, and verification matrices.
