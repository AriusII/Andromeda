# Roadmap Delegation Tree Checklist

## Use this checklist for

Build a master-to-student delegation model for Codex agents. Use when one central agent must route subtasks to specialized agents while preserving context, scope, and output contracts.
...
```text
delegation tree, specialist routing, return contract, integration path
```
