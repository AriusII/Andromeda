# Roadmap Progress Checkpointing Checklist

## Use this checklist for

Create checkpoints for long-running Codex work within a single response: completed items, partial results, blockers, risks, and next executable step. Use for major refactor, audit, design, or tooling work.
...
```text
progress ledger, completed work, active risks, next gate
```
