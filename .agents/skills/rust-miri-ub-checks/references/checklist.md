# Rust Miri UB Checks Checklist

## Use this checklist for

Use Miri for unsafe wrappers and pointer-sensitive Rust tests. Use when unsafe code, raw pointers, aliasing, or layout assumptions need validation.
...
```text
Miri target, test subset, expected limitations
```
