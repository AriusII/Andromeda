# Map Summarizability Review Checklist

## Use this checklist for

Review analytical Maps for grain, summarizability, aggregation correctness, staleness, layout, and GPU batch boundaries. Use for OLAP/analytics maps.
...
```text
grain, aggregation, refresh, no commit burden
```
