...
Threat-model certificate theft, replay, oversized payloads, contract probing, admin abuse, split-brain, ransomware, slow clients, and replica poisoning. Use for security reviews.
...
```text
threat, defense, trace, residual risk
```
