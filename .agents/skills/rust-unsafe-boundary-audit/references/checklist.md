# Rust Unsafe Boundary Audit Checklist

## Use this checklist for

Audit unsafe Rust blocks, unsafe functions, target-feature code, raw pointers, and memory layout assumptions. Use in storage, WAL, FFI, SIMD, and lock-free code.
...
```text
safety comment, invariants, tests, Miri/fuzz
```
