# Rust Clean Code Refactor Checklist

## Use this checklist for

Refactor Rust code without behavior changes. Use for simplification, naming, extraction, deduplication, visibility reduction, and stronger invariants.
...
```text
behavior lock, tests first, small changes, cleanup
```
