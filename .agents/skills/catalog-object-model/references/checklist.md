# Catalog Object Model Checklist

## Use this checklist for

Design catalog descriptors for Database, Namespace, Table, Map, Enum, StructuredObject, Procedure, versions, policies, and state lifecycles. Use for catalog implementation.
...
```text
descriptor, lifecycle, version, invalidation
```
