# GPU No Commit Policy Checklist

## Use this checklist for

Enforce that GPU jobs are analytics/statistics/vector/batch only and never participate in commit, WAL, rollback, recovery, security, or OLTP visibility. Use for GPU proposals.
...
```text
allowed, forbidden, cancellation, fallback
```
