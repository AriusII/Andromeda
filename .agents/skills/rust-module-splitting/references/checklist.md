# Rust Module Splitting Checklist

## Use this checklist for

Split Rust modules by responsibility, not by arbitrary size. Use when files become large or mix parsing, validation, I/O, tests, and runtime logic.
...
```text
module tree, extraction order, visibility reduction
```
