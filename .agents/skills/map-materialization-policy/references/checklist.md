# Map Materialization Policy Checklist

## Use this checklist for

Select Map refresh modes: Immediate, Incremental, Deferred, SnapshotOnly with WAL, consistency, cost, and staleness policies. Use for Maps design.
...
```text
refresh mode, consistency, cost, staleness
```
