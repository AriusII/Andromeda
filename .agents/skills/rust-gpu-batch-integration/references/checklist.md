# Rust GPU Batch Integration Checklist

## Use this checklist for

Integrate GPU acceleration only for batch analytics/statistics/vector workloads outside commit path. Use when designing wgpu/CUDA/ROCm adapters or GPU policies.
...
```text
workload class, CPU fallback, cancellation, no commit
```
