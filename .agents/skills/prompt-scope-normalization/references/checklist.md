# Prompt Scope Normalization Checklist

## Use this checklist for

Normalize oversized or emotional prompts into a precise engineering work order. Use when Codex must turn broad ambition into a bounded, testable, mission-critical task.
...
```text
normalized ask, constraints, deliverables, validation, non-goals
```
