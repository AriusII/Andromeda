# Rust Property Testing Checklist

## Use this checklist for

Use property-based tests for deterministic invariants, codecs, canonicalization, state machines, and algebraic laws. Use with proptest-style generators.
...
```text
generator, invariant, shrink, reproducibility
```
