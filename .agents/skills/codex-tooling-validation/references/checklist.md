# Codex Tooling Validation Checklist

## Use this checklist for

Validate the full Codex tooling tree: AGENTS.md, .codex/config.toml, .codex/agents, .agents/skills, hooks, scripts, and prompt templates.
...
```text
required paths, registry, skill frontmatter, hook scripts
```
