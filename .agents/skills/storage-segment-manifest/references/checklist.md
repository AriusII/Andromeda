# Storage Segment Manifest Checklist

## Use this checklist for

Design root pointer, manifests, WAL/hot/cold segments, SegmentIndex, hashes, signatures, AEAD, and startup path. Use for physical storage format.
...
```text
root, manifest, segment, index, validation
```
