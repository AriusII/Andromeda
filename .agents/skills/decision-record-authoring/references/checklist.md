# Decision Record Authoring Checklist

## Use this checklist for

Create ADR/DEC records with context, decision, alternatives, consequences, revision criteria, and test gates. Use for architecture, tooling, Rust, WAL, SRPL, hook, or agent policy decisions.
...
```text
context, decision, alternatives, consequences, review trigger
```
