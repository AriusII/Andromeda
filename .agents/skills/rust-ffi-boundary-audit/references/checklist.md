# Rust FFI Boundary Audit Checklist

## Use this checklist for

Review Rust FFI boundaries for unsafe extern, ABI, ownership, lifetimes, error propagation, and build-script behavior. Use for OS, GPU, crypto, storage, or C library integration.
...
```text
ABI, ownership, errors, build.rs, safety
```
