# Codex Agent Authoring Checklist

## Use this checklist for

Create or update Codex agent TOML definitions with clear agent role, non-overlapping behavior, sandbox posture, primary skills, and output contracts.
...
```text
role boundary, sandbox mode, primary skills, delegation rules
```
