# IAM Security Policy Checklist

## Use this checklist for

Design mTLS to CertificateIdentity to UserPrincipal to roles/permissions/policies/audit. Use for security and authorization implementation.
...
```text
identity chain, policy, deny, audit
```
