# Rust CI Quality Gates Checklist

## Use this checklist for

Define CI gates for Rust format, check, clippy, nextest, docs, audit, deny, feature matrix, fuzz, Miri, coverage, and benchmarks.
...
```text
gate matrix, criticality, command, failure policy
```
