# Storage Page Format Checklist

## Use this checklist for

Design PageHeader, PageTrailer, layout variants, fixed/hybrid rows, column segments, overflow, checksums, and page invariants. Use for storage pages.
...
```text
header, trailer, layout, checksum
```
