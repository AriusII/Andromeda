# SRPL Binder Cardinality Checklist

## Use this checklist for

Bind SRPL names, types, scopes, cardinalities, effects, read/write sets, and permissions. Use when validating procedures before planning.
...
```text
name resolution, type check, cardinality, effects
```
