# Rust Dependency Pruning Checklist

## Use this checklist for

Prune unused, duplicated, risky, or over-featured Cargo dependencies. Use with cargo tree, cargo machete, udeps, deny, and audit.
...
```text
dependency evidence, feature graph, removal plan
```
