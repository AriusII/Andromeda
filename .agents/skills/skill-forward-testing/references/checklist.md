# Skill Forward Testing Checklist

## Use this checklist for

Forward-test skills with realistic tasks and no leaked expected answer. Use when validating whether a skill works for future Codex agents.
...
```text
test prompt, raw artifacts, contamination control, pass/fail signals
```
