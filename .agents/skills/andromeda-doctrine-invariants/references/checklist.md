# Andromeda Doctrine Invariants Checklist

## Use this checklist for

Apply Andromeda invariants: RPC-only procedures, typed contracts, durable WAL before visible commit, versioned stats/plans, no GPU commit path, and recoverability. Use for any design or code review.
...
```text
strict boundaries, adaptive internals, C5 invariants
```
