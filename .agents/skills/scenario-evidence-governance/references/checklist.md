# Scenario Evidence Governance Checklist

## Use this checklist for

Govern ScenarioEvidence, confidence/criticality/freshness/realism/stability scores, expiration, validation, and optimizer consumption. Use for predictive evidence.
...
```text
scores, validation, expiration, no sole decision
```
