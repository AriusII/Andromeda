# Learned Component Skepticism Checklist

## Use this checklist for

Evaluate learned cardinality, learned indexes, learned optimizer, and workload prediction as evidence only with fallback and poisoning defenses. Use for modern ML-adjacent proposals.
...
```text
evidence, fallback, drift, poisoning
```
