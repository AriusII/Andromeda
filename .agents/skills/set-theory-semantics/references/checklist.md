# Set Theory Semantics Checklist

## Use this checklist for

Reason about set semantics, absence of duplicates, relations, tuples, projection, membership, and explicit multiset/sequence boundaries. Use in SRPL and optimizer design.
...
```text
set vs bag, relation, sequence, duplicate policy
```
