# ContractHash Canonicalization Checklist

## Use this checklist for

Define stable ContractHash canonicalization across shapes, types, permissions, policies, compatibility, and semantic IR. Use when hashing procedures/contracts.
...
```text
canonical form, hash inputs, golden tests
```
