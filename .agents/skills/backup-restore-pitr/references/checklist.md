# Backup Restore PITR Checklist

## Use this checklist for

Design backup, WAL archives, immutable retention, PITR restore, restore tests, and backup policies. Use for operations and DR work.
...
```text
snapshot, WAL archive, target LSN, test
```
