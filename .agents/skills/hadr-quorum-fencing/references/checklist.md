# HA/DR Quorum and Fencing Checklist

## Use this checklist for

Design single-primary HA/DR, replica metadata, quorum, fencing, promotion eligibility, epochs, and split-brain prevention. Use for HA/DR work.
...
```text
primary, replica, quorum, fencing, epoch
```
