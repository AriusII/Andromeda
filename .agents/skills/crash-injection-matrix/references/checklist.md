# Crash Injection Matrix Checklist

## Use this checklist for

Build and maintain crash injection matrices for WAL, manifest, page, map, catalog, backup, and recovery. Use when designing tests or validating C5 paths.
...
```text
matrix, injection, expected recovery
```
