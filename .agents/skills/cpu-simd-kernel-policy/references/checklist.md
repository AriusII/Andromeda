# CPU SIMD Kernel Policy Checklist

## Use this checklist for

Govern CPU acceleration for CRC, encryption, scans, bitmap/cardinality, compression, and atomics with scalar fallback and evidence. Use for CPU kernels.
...
```text
kernel, feature, benchmark, fallback
```
