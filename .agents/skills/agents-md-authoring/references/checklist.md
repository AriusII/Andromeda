# AGENTS.md Authoring Checklist

## Use this checklist for

Author and maintain repository-level AGENTS.md instructions for Codex. Use when defining project doctrine, hierarchy, scope, precedence, and contribution rules.
...
```text
scope hierarchy, project invariants, contribution rules, precedence
```
