# Agent Skill Routing Checklist

## Use this checklist for

Select agents and skills for a user request based on task type, criticality, Rust area, Andromeda subsystem, and risk class. Use when Codex must dynamically load the right skills.
...
```text
routing rules, triggers, criticality, fallback agent
```
