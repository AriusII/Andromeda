# Rust Performance Benchmarking Checklist

## Use this checklist for

Design measured Rust performance work with hypotheses, benchmarks, profiles, baselines, and regression thresholds. Use before accepting optimizations.
...
```text
hypothesis, benchmark, profiling, regression budget
```
