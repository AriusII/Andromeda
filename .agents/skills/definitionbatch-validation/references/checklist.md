# DefinitionBatch Validation Checklist

## Use this checklist for

Validate DefinitionBatch dependency graph, ordering, DryRun, breaking changes, security impact, storage impact, and transactionality. Use for import/modelization work.
...
```text
dependency graph, dry run, rollback, audit
```
