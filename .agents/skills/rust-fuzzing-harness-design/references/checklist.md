# Rust Fuzzing Harness Design Checklist

## Use this checklist for

Create fuzz harnesses for parsers, binary codecs, RPC frames, WAL, pages, manifests, and SegmentIndex. Use for untrusted or persisted bytes.
...
```text
target, input bounds, no panic, corpus
```
