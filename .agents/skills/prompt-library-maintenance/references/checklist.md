# Prompt Library Maintenance Checklist

## Use this checklist for

Maintain reusable prompt templates for Codex agents, reviews, cleanup, crash tests, SRPL specs, and Rust implementation tasks.
...
```text
template inventory, variables, output contract, examples
```
