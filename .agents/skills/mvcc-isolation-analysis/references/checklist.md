# MVCC Isolation Analysis Checklist

## Use this checklist for

Analyze MVCC visibility, snapshots, GC, anomalies, snapshot isolation, serializable behavior, and long-reader retention. Use for transaction/isolation design.
...
```text
visibility, anomaly, snapshot, GC
```
