# Rust Error Modeling Checklist

## Use this checklist for

Design typed Rust errors for library, engine, RPC, transaction, storage, and business boundaries. Use to replace stringly errors or panic paths.
...
```text
error family, code, source, retry, RPC conversion
```
