# Rust Crate Boundary Design Checklist

## Use this checklist for

Define crate boundaries by responsibility for Andromeda engine subsystems. Use when splitting or reviewing crates to avoid god crates and utility dumping grounds.
...
```text
responsibility, dependencies, public API, no cycles
```
