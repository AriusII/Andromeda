# Optimizer Cost Modeling Checklist

## Use this checklist for

Design cost model terms, physical operators, plan candidates, risk penalties, plan classes, and DecisionTrace for Andromeda procedures. Use for optimizer work.
...
```text
cost terms, candidates, risk, trace
```
