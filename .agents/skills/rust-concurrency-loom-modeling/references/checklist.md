# Rust Concurrency Loom Modeling Checklist

## Use this checklist for

Model small Rust concurrency primitives with Loom. Use for atomics, pin guards, latches, lock-free queues, and backpressure flags.
...
```text
state model, interleavings, assertions, limits
```
