# Rust Workspace Architecture Checklist

## Use this checklist for

Design and review a Rust 2024 Cargo workspace for a systems-grade database engine. Use when defining crates, members, profiles, lints, and dependency policy.
...
```text
workspace layout, resolver, MSRV, profiles, lints
```
