# SRPL Language Design Checklist

## Use this checklist for

Design SRPL as a strict relational procedure language with English-like canonical syntax, explicit absence, explicit cardinality, bounded loops, and IR compilation.
...
```text
syntax, semantics, restrictions, IR
```
