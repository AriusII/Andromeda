# Rust Test Strategy Checklist

## Use this checklist for

Design a layered Rust test strategy: unit, integration, property, fuzz, Miri, Loom, crash/recovery, HA/DR, E2E, and benchmarks.
