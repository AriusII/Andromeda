# Rust Async Cancellation Checklist

## Use this checklist for

Design cancellation-safe async Rust around QUIC/RPC/admin jobs without corrupting transaction or storage state. Use for Tokio tasks, streams, shutdown, and backpressure.
...
```text
await boundaries, cancellation, shutdown, owned state
```
