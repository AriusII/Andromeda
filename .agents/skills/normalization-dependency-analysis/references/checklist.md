# Normalization Dependency Analysis Checklist

## Use this checklist for

Analyze functional dependencies, multivalued dependencies, keys, 3NF, BCNF, 4NF, DKNF, lossless decomposition, and dependency preservation. Use for catalog/modelization review.
...
```text
FDs, keys, decomposition, normal forms
```
