# Rust Newtype Invariants Checklist

## Use this checklist for

Use Rust newtypes and checked constructors for IDs, hashes, LSNs, versions, domain primitives, and invariants. Use when primitive obsession risks bugs.
...
```text
newtype, constructor, validation, serialization
```
