# Rust Binary Codec Design Checklist

## Use this checklist for

Design and implement explicit Rust binary codecs for persisted and network formats. Use for WAL, pages, manifests, SegmentIndex, RPC frames, and contract hashes.
...
```text
codec traits, endian, bounds, no transmute, fuzz
```
