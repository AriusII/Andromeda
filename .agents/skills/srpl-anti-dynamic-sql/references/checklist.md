# SRPL Anti Dynamic SQL Checklist

## Use this checklist for

Reject dynamic SQL/text construction, implicit names, SELECT *, shape-shifting returns, unbounded loops, and ambient NULLs in SRPL. Use during language review.
...
```text
forbidden pattern, strict alternative
```
