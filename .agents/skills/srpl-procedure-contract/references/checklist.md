# SRPL Procedure Contract Checklist

## Use this checklist for

Specify ProcedureContract fields, ContractHash, input/output shapes, permissions, read/write sets, isolation, resource policy, and compatibility. Use for RPC and catalog work.
...
```text
contract fields, hash, compatibility, policy
```
