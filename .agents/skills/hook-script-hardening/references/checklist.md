# Hook Script Hardening Checklist

## Use this checklist for

Harden Python hook scripts for deterministic JSON input/output, safe failures, no secret leakage, and bounded execution. Use when writing or reviewing hook scripts.
...
```text
stdin parsing, JSON output, safe errors, no side effects
```
