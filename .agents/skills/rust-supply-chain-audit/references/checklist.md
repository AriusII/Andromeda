# Rust Supply Chain Audit Checklist

## Use this checklist for

Audit Cargo dependencies, advisories, licenses, sources, transitive graph, and vet status. Use before adding dependencies or release gates.
...
```text
audit, deny, vet, license, transitive risk
```
