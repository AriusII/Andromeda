# Source-Grounded Answering Checklist

## Use this checklist for

Answer using project and official sources with explicit citations, source hierarchy, uncertainty, and cross-checks. Use when claims must be traceable to uploaded documents, repository files, or official documentation.
...
```text
source hierarchy, citation placement, freshness, uncertainty
```
