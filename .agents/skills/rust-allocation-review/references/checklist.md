# Rust Allocation Review Checklist

## Use this checklist for

Review allocations, clones, String/Vec growth, buffer reuse, preallocation, and hot-path memory pressure. Use for performance-sensitive Rust code.
...
```text
allocation sites, capacity, clone cost, measurement
```
