# Audit Trace Schema Checklist

## Use this checklist for

Design audit traces for security, catalog changes, admin operations, procedures, transactions, plans, recovery, cluster events, and DefinitionBatch. Use for observability.
...
```text
trace fields, correlation, retention
```
