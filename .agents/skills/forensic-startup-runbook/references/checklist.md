# Forensic Startup Runbook Checklist

## Use this checklist for

Design FastStart, SafeStart, ForensicStart, consistency reports, app blocking, corruption response, and RecoveryReport. Use for incident recovery.
...
```text
start mode, report, block app, validation
```
