# Rust Dead Code Removal Checklist

## Use this checklist for

Identify and remove dead code, unused imports, unused functions, stale tests, obsolete docs, and unreachable paths. Use during cleanup cycles.
...
```text
evidence, removal safety, tests, rollback path
```
