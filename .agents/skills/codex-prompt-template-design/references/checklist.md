# Codex Prompt Template Design Checklist

## Use this checklist for

Design reusable prompts for Codex agent work: implementation, review, cleanup, tests, research, specification, and recovery plans. Use when creating prompt libraries or templates.
...
```text
template variables, output contract, constraints, validation
```
