# Observability Decision Trace Checklist

## Use this checklist for

Design DecisionTrace and operational metrics so optimizer, stats, security, storage, and recovery decisions are explainable after the fact. Use for traceability.
...
```text
decision, evidence, version, metrics
```
