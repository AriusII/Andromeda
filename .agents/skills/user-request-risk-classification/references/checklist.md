# User Request Risk Classification Checklist

## Use this checklist for

Classify requests by risk, destructive potential, security impact, recovery impact, and required review posture. Use before edits, shell commands, refactors, deletion, or policy changes.
...
```text
risk level, required sandbox, approval needs, validation
```
