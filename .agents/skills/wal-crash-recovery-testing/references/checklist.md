# WAL Crash Recovery Testing Checklist

## Use this checklist for

Design crash tests for before/after WAL flush, TxCommit, dirty page flush, manifest switch, Map delta, WAL truncation, and recovery reports. Use for C5 validation.
...
```text
injection point, expected state, recovery report
```
