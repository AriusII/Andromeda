# Skill Progressive Disclosure Checklist

## Use this checklist for

Design skills that keep SKILL.md lean while moving details to references, scripts, or assets. Use when a skill risks becoming too long or duplicative.
...
```text
metadata, body, references, scripts, assets
```
