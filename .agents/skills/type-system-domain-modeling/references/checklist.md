# Type System Domain Modeling Checklist

## Use this checklist for

Design scalars, decimals, floats, text, binary, domain types, enums, flags, optional types, and collection cardinality. Use for TypeSystem v0.
...
```text
type category, invariant, serialization
```
