# Rust Panic Eradication Checklist

## Use this checklist for

Remove panic, unwrap, expect, todo, dbg, and uncontrolled aborts from mission-critical runtime paths. Use in WAL, recovery, RPC, security, and storage.
...
```text
panic site, replacement error, test, criticality
```
