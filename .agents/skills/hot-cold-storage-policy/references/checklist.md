# Hot/Cold Storage Policy Checklist

## Use this checklist for

Design RAM, NVMe HotStore, WAL, TempStore, HDD ColdStore, snapshots, and reconstruction truth. Use for storage architecture.
...
```text
truth model, hot/cold, snapshot, WAL
```
