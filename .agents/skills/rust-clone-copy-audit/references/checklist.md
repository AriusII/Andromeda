# Rust Clone and Copy Audit Checklist

## Use this checklist for

Audit Clone, Copy, Arc, Bytes, Cow, borrowing, and ownership choices in hot paths. Use when performance, lifetime, or memory pressure matters.
...
```text
clone frequency, payload size, borrow alternative
```
