---
name: rust-clone-copy-audit
description: "Audit Clone, Copy, Arc, Bytes, Cow, borrowing, and ownership choices in hot paths. Use when performance, lifetime, or memory pressure matters."
---

# Rust Clone and Copy Audit

## Purpose

Use this skill to execute a focused, reusable workflow for **Rust Clone and Copy Audit** in the Andromeda project.
