# SessionStart Context Checklist

## Use this checklist for

Inject compact Andromeda mission context at session start. Use to keep Codex aligned with strict boundaries, Rust baseline, and core invariants.
...
```text
project doctrine, high-risk zones, default validation
```
