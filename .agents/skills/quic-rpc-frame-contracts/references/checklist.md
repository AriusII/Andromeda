# QUIC/RPC Frame Contracts Checklist

## Use this checklist for

Design QUIC surfaces, FrameHeader, RPC frame types, structured payloads, metadata-before-payload, and error taxonomy. Use for network/RPC work.
