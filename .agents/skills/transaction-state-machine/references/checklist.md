# Transaction State Machine Checklist

## Use this checklist for

Design transaction lifecycle: Created, Active, Committing, Committed, Failed, Poisoned, RollingBack, RolledBack, Disposed. Use for transaction kernel work.
...
```text
state, transition, failure, poison
```
