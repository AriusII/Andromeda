# StructuredObject Contracts Checklist

## Use this checklist for

Design StructuredObject shapes, row counts, layouts, intrinsic invariants, RPC metadata, and contract compatibility. Use for batch parameters and result types.
...
```text
shape, layout, rowcount, intrinsic invariant
```
