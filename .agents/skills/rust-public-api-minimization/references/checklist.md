# Rust Public API Minimization Checklist

## Use this checklist for

Reduce public API surface using private, pub(super), pub(crate), sealed traits, and stable reexports. Use when crates expose too much.
...
```text
visibility audit, public contract, semver impact
```
