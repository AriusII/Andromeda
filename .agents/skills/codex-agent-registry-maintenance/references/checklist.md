# Codex Agent Registry Maintenance Checklist

## Use this checklist for

Maintain .codex/config.toml agent registry entries and ensure each agent file is registered and coherent. Use when adding, renaming, deleting, or reorganizing agents.
...
```text
registry parity, config_file validity, naming, duplicate detection
```
