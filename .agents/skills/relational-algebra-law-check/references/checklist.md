# Relational Algebra Law Check Checklist

## Use this checklist for

Check relational algebra rewrites under set semantics, projection, selection, join, union, difference, aggregation, and bag-semantics caveats. Use for optimizer and SRPL reasoning.
...
```text
law, preconditions, semantic model, counterexample
```
