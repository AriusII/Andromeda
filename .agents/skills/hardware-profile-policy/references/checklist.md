# Hardware Profile Policy Checklist

## Use this checklist for

Define hardware profiles for x64/arm64, SIMD, GPU, NVMe, HDD, ZNS, and runtime detection with policy and fallback. Use for hardware-aware design.
...
```text
profile, detection, fallback, policy
```
