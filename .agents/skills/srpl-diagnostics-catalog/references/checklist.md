# SRPL Diagnostics Catalog Checklist

## Use this checklist for

Create stable SRPL diagnostic codes for type, cardinality, map, resource, contract, and determinism errors. Use for compiler and CI outputs.
