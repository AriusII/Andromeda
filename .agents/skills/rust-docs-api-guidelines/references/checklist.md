# Rust Docs API Guidelines Checklist

## Use this checklist for

Document Rust APIs with crate docs, examples, errors, safety, panics, versioning, and observability. Use for public crates or stable internal APIs.
...
```text
rustdoc, examples, safety, error docs
```
