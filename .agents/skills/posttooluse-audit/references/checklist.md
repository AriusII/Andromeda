# PostToolUse Audit Checklist

## Use this checklist for

Audit tool outputs after execution and inject follow-up context for validation, tests, or cleanup. Use after file edits, shell commands, searches, or validation scripts.
...
```text
tool output, changed files, test implication, audit note
```
