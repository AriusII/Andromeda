# Rust Orphan Detection Checklist

## Use this checklist for

Find orphan files, modules, dependencies, features, examples, benches, scripts, fixtures, and docs. Use for repository cleanup and integrity checks.
...
```text
orphan category, detection method, decision
```
