# Roadmap Objective Tracing Checklist

## Use this checklist for

Track large Andromeda roadmap prompts, objectives, dependencies, status signals, constraints, and unresolved decisions. Use when Codex must preserve a long mission-critical roadmap, derive work items, or verify that a response stays aligned with the requested objectives.
...
```text
objective map, dependency chain, decision status, risk status, exit criteria
```
