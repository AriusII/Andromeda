# Hook JSON Validation Checklist

## Use this checklist for

Validate .codex/hooks.json structure, event names, command paths, timeouts, matchers, and referenced scripts. Use before packaging or committing Codex hooks.
...
```text
event coverage, command existence, timeout, status message
```
