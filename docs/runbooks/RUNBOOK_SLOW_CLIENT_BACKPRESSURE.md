# Slow client backpressure runbook
...
A client cannot consume ResultStream batches fast enough.
...
- Spool under quota if policy allows.
- Close abusive sessions after policy threshold.
- Ensure WAL flush priority is unaffected.
