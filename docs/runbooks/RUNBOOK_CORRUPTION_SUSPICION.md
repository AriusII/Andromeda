...
CRC, hash, manifest, page, index, or Map validation detects inconsistency.
...
- Fence writes.
- Switch to Suspended or ForensicOnly.
- Validate manifest, SegmentIndex, WAL, and snapshots.
- Compare table/index/Map consistency.
- Restore or rebuild only after evidence is recorded.
