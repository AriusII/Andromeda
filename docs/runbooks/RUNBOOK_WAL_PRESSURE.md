...
WAL queue depth, flush latency, or mirror lag threatens commit throughput.
...
- Protect WAL P0 I/O.
- Throttle non-critical Procedure execution.
- Suspend analytics, GPU jobs, stats builds, and benchmark scenarios.
- Reduce or reject large ResultStreams when policy allows.
- Emit AdminOperationTrace and TransactionTrace evidence.
