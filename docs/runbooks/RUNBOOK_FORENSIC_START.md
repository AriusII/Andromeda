...
A database must start for investigation without accepting application mutations.
...
- Block Application Surface.
- Load root, manifest, SegmentIndex, and WAL in forensic mode.
- Produce consistency report.
- Allow only authorized Administration Surface operations.
- Preserve evidence.
