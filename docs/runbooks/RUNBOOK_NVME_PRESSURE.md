...
NVMe temp, spill, WAL, HotStore, or version store pressure threatens stability.
...
- Reserve WAL priority.
- Throttle temp-heavy plans.
- Suspend GPU and benchmark jobs.
- Trigger checkpoint only when safe.
- Record write amplification and queue depth.
