...
Backup, restore, or PITR validation is required.
...
- Select cold snapshot.
- Verify manifest and SegmentIndex.
- Replay WAL to target LSN when PITR is requested.
- Validate catalog, security, storage, and audit invariants.
- Open ReadOnly test before production promotion.
