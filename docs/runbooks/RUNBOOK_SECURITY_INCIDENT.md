...
Suspicious certificate use, permission abuse, replay attempt, or break-glass event occurs.
...
- Revoke or fence certificate.
- Preserve SecurityAuditTrace.
- Review SurfaceScope and UserPrincipal.
- Disable principal if required.
- Rotate credentials and verify audit chain.
