...
Database starts after crash, operator-requested restore, or failed manifest validation.
...
- Start in SafeStart unless FastStart is explicitly safe.
- Read root and manifest.
- Replay WAL from RequiredWalStartLsn.
- Rollback incomplete transactions.
- Emit RecoveryReport before Online.
