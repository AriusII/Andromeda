...
| Storage and recovery | `SPEC_TRANSACTION_STATE_MACHINE_V0.md`, `SPEC_WAL_RECORD_V0.md`, `SPEC_FILE_WAL_SEGMENT_V0.md`, `SPEC_PAGE_FORMAT_V0.md`, `SPEC_DATABASE_MANIFEST_V0.md`, `SPEC_SEGMENT_INDEX_V0.md`, `SPEC_RECOVERY_REPORT_V0.md` |
| RPC, security, and audit | `SPEC_RPC_FRAME_V0.md`, `SPEC_SECURITY_ADMISSION_V0.md`, `SPEC_AUDIT_LEDGER_V0.md` |
