...
|---|---|
| `WalSegmentHeader` | Must be represented as an explicit typed structure or canonical descriptor. |
| `WalSegmentTrailer` | Must be represented as an explicit typed structure or canonical descriptor. |
| `TimelineId` | Must be represented as an explicit typed structure or canonical descriptor. |
