...
Define the minimal strict SRPL grammar for transaction-scoped Procedures.
...
|---|---|
| `procedure_decl` | Must be represented as an explicit typed structure or canonical descriptor. |
