# P8 — Statistics and optimizer V0
...
Introduce CPU statistics, bounded cost model, PlanCacheKey, and DecisionTrace.
...
|---|---|
| `CPU statistics` | Implemented or specified with observable acceptance evidence. |
| `StatsVersion candidate publication` | Implemented or specified with observable acceptance evidence. |
| `cost model` | Implemented or specified with observable acceptance evidence. |
| `PlanCacheKey` | Implemented or specified with observable acceptance evidence. |
| `DecisionTrace` | Implemented or specified with observable acceptance evidence. |
| `hysteresis` | Implemented or specified with observable acceptance evidence. |

## Acceptance checks

- Stats candidate cannot publish without validation.
- Plan uses catalog, stats, and policy versions.
- DecisionTrace lists candidates and rejections.
