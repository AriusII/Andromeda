# Scope Personne 13 — Lead IAM, principal, security admission et permissions

## Mission

Gère CertificateIdentity, UserPrincipal, permissions, policies, deny/allow et admission fail-closed.
