# ADR-0015-PLAN CACHE KEY AND PLAN CLASS — PlanCacheKey and PlanClass policy
...
Plan cache identity includes contract, catalog, stats, policy, shape, and bounded class.
