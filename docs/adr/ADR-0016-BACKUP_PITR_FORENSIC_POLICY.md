# ADR-0016-BACKUP PITR FORENSIC POLICY — Backup, PITR, and forensic startup policy
...
Treat backup as distinct from HA/DR and require tested restore and ForensicStart behavior.
