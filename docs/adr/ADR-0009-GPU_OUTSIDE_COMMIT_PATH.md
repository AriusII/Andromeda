# ADR-0009-GPU OUTSIDE COMMIT PATH — GPU exclusion from commit path
...
GPU may accelerate analytics and statistics, but never commit, WAL, rollback, recovery, MVCC visibility, or security-critical authorization.
