...
Factual claims about Codex, Rust, and Andromeda must be grounded in official or project sources when possible.

## Consequences

Improves trust, reduces stale assumptions, and supports mission-critical review.
