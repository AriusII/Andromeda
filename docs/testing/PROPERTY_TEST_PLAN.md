...
| Area | Requirement |
|---|---|
| `encode/decode roundtrip` | Must have explicit test evidence or a documented exclusion. |
| `invalid length never panics` | Must have explicit test evidence or a documented exclusion. |
| `LSN ordering is monotonic` | Must have explicit test evidence or a documented exclusion. |
| `ContractHash is deterministic` | Must have explicit test evidence or a documented exclusion. |
| `catalog dependency sort is stable` | Must have explicit test evidence or a documented exclusion. |
| `page free-space accounting never underflows` | Must have explicit test evidence or a documented exclusion. |
| `StatsVersion invalid transitions are rejected` | Must have explicit test evidence or a documented exclusion. |
