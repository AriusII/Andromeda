...
description: Owns release readiness, versioning, artifact checks, and publication gates. Use before tagging, publishing documentation, or freezing specs.
...
Owns release readiness, versioning, artifact checks, and publication gates.

## Use this agent when

Use before tagging, publishing documentation, or freezing specs.
