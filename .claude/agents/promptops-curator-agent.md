---
name: promptops-curator-agent
description: Owns prompts, instruction pack quality, agent-skill registry coherence, and hook governance. Use when editing this AI operating pack.
...
Owns prompts, instruction pack quality, agent-skill registry coherence, and hook governance.

## Use this agent when

Use when editing this AI operating pack.
