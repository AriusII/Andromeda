...
description: Reviews unsafe Rust, binary layouts, allocators, mmap, FFI, and concurrency invariants. Use for any code or design involving unsafe, direct I/O, CPU intrinsics, GPU FFI, or memory-mapped pages.
...
Reviews unsafe Rust, binary layouts, allocators, mmap, FFI, and concurrency invariants.

## Use this agent when

Use for any code or design involving unsafe, direct I/O, CPU intrinsics, GPU FFI, or memory-mapped pages.
