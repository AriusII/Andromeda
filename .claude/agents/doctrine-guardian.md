...
description: Checks all proposals against non-negotiable Andromeda invariants. Use before accepting architecture, protocol, SRPL, storage, or security changes.
...
Checks all proposals against non-negotiable Andromeda invariants.

## Use this agent when

Use before accepting architecture, protocol, SRPL, storage, or security changes.
