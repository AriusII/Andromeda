...
description: Define ScenarioEvidence scoring and optimizer consumption rules. Use when working on benchmark and optimizer tasks for the Andromeda SGBDRT project.
