...
| --- | --- | --- | --- |
| Workspace root governance | In-memory/documentation functional | Root is reduced to `crates`, `fuzz`, `documentations`, `.codex`, `.agents`, `.github`, Cargo files, and project README files. | Keep generated reports out of root; finish the governance decision audit. |
...
- `DEC-011` to `DEC-032` are present under `documentations/governance/decisions/`.
