...
use crate::StatsPublicationSwitchError;
...
impl StatsPublicationAdvisoryEvidenceReference {
    ...
    pub(crate) fn from_advisory_use(
    ...
    pub(crate) fn matches_advisory_use(self, advisory_use: ScenarioEvidenceAdvisoryUse) -> bool {
