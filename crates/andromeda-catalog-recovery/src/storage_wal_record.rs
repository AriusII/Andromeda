...
pub enum CatalogStorageWalRecordVersion {
    /// Initial version (V1): deterministic Protobuf encoding with SHA256 checksum
    V1 = 1,
}

impl CatalogStorageWalRecordVersion {
...
pub enum CatalogStorageWalRecord {
...
mod tests {
    ...
    fn catalog_wal_record_version_current_is_v1() {
        assert_eq!(
            ...
            CatalogStorageWalRecordVersion::V1
        );
        assert_eq!(CatalogStorageWalRecordVersion::CURRENT.as_u16(), 1);
    }

    #[test]
    fn catalog_wal_record_version_try_from_u16_accepts_v1() {
        let v = CatalogStorageWalRecordVersion::try_from_u16(1);
        assert!(v.is_ok());
        assert_eq!(v.unwrap(), CatalogStorageWalRecordVersion::V1);
    }

    #[test]
    fn catalog_wal_record_version_try_from_u16_rejects_invalid() {
        let v = CatalogStorageWalRecordVersion::try_from_u16(99);
        assert!(v.is_err());
    ...
    fn definition_batch_applied_catalog_version_is_visible() {
        let record = CatalogStorageWalRecord::DefinitionBatchApplied {
            batch_id: 1,
    ...
    fn statistics_updated_has_no_catalog_version() {
        let record = CatalogStorageWalRecord::StatisticsUpdated {
            stats_version: 1,
    ...
    fn procedure_added_validates_non_zero_hash() {
        let record = CatalogStorageWalRecord::ProcedureAdded {
    ...
    fn procedure_dropped_validates_version_ordering() {
        let record = CatalogStorageWalRecord::ProcedureDropped {
            procedure_id: CatalogObjectId::new(1),
