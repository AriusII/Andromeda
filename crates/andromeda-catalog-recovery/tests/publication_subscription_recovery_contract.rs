use andromeda_catalog_recovery::{
    ...
    CatalogSubscriberRegistration, catalog_visible_change_audit_evidence_for_publication,
...
fn replay_is_idempotent_for_duplicate_publication_ack_and_terminal_records() {
    ...
    let summary = replay_publication_subscription_changes([
        CatalogPublicationSubscriptionReplayRecord::Terminal(terminal.clone()),
        CatalogPublicationSubscriptionReplayRecord::Terminal(terminal),
        CatalogPublicationSubscriptionReplayRecord::VisiblePublication {
        ...
        CatalogPublicationSubscriptionReplayRecord::SubscriptionAcknowledgement(acknowledgement),
    ])
    .unwrap();
