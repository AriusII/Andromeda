...
use entry::promote_compatible_waiters;
use mode::{held_mode_covers_requested, is_v0_upgrade};

pub use entry::{LockEntry, LockHolder, LockWaiter};
pub use mode::LockMode;
pub use resource::{CatalogIntentionLocks, LockRequest, LockResource};
