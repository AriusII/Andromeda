...
use crate::{
    ...
    TransactionStatusStore, WalRecordKind, encode_commit_payload, encode_rollback_payload,
};
...
pub struct CommitLogManager<S: TransactionStatusStore> {
...
impl<S: TransactionStatusStore> CommitLogManager<S> {
    pub fn new(wal_manager: Arc<dyn InvocationWal>, status_table: Arc<S>) -> Self {
