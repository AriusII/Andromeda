//! Storage placement planning for immutable cold segment publication.
//!
//! The plan validates that a sealed hot segment can be routed to the cold
//! publication path. It does not publish, persist, or mutate manifest truth.

use andromeda_error::{AndromedaError, AndromedaErrorKind, AndromedaResult};
use andromeda_hardware::PipelineClass;
use andromeda_segment::SegmentDescriptor;

use crate::{
    CoreIoPlacementDecision, CoreIoPlacementPolicy, CoreIoPlacementRequest, IoPathBudget,
    IoPathClass, IoUseClass, PipelineStage, PlacementDecision, StorageIoBudgetScope, StorageTier,
