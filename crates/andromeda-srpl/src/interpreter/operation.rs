use crate::{
    ...
    execution_adapter::{
        ...
        SrplExecutionFailure, SrplFailureAdapter, SrplFailureRequest, SrplReadRequest,
        SrplReadResult, SrplRowBound, SrplTypedEmitAdapter, SrplTypedReadAdapter,
        ...
        + SrplFailureAdapter,
{
    ...
    fn execute_update(
        &mut self,
        ordinal: u32,
        target: &andromeda_catalog::CatalogObjectRef,
        predicates: &[SrplPredicateIr],
