...
impl InvocationReject {
    ...
    /// evidence because no transaction was ever created.
...
mod tests {
    ...
    fn invocation_rejects_stats_version_mismatch_before_transaction_creation() {
        ...
        executable_binding.stats_version = StatsVersion::new(2);
    ...
    fn invocation_reject_can_be_emitted_as_pre_transaction_audit_evidence() {
        ...
        .expect("pre-transaction contract rejection remains auditable");
