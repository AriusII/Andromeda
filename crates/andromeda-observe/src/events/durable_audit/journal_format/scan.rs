...
pub(in crate::events::durable_audit) fn replay_durable_audit_journal(
    path: &Path,
...
pub(in crate::events::durable_audit) fn replay_durable_audit_journal_with_evidence(
    path: &Path,
    query: &DurableAuditReplayQuery,
...
pub(in crate::events::durable_audit) fn next_record_anchor(
    path: &Path,
