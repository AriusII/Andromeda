...
pub(super) fn digest_bytes(bytes: &[u8]) -> BackupResult<BackupArtifactDigest> {
    if bytes.is_empty() {
...
pub(super) fn compute_wal_archive_digest<L: BackupLsn>(
    wal_segments: &[BackupWalSegmentArtifact<L>],
) -> [u8; 32] {
