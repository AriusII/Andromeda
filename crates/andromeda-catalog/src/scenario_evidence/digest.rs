...
///
/// Equal records produce equal digests; differing records produce differing
/// digests with overwhelming probability (SHA-256). Tag bytes and
/// little-endian widths make the encoding stable across architectures.
