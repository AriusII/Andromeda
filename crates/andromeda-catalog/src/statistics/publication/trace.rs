...
use crate::digest::digest_prefix_hex;

use super::{
    error::StatsPublicationSwitchError,
    evidence::{StatsPublicationAdvisoryEvidenceReference, StatsPublicationDecisionEvidence},
    model::StatsPublicationSummary,
};
...
pub(super) fn publication_trace(
    trace_id: TraceId,
...
pub(super) fn validate_switch_trace_id(
    trace_id: TraceId,
