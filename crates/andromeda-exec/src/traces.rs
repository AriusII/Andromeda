...
//! - `ProcedureDispatcher::dispatch_procedure` → `DispatchEventTrace`
//! - `LocalVerticalRuntime::execute` → `ExecutionStartTrace`
//! - Commit/rollback completion → `ExecutionEndTrace` (bound to terminal LSN)
//!
//! ## Trace Correlation
//!
