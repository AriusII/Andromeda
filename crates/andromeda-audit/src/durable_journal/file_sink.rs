...
use super::{
    DurableAuditAppendRecord, DurableAuditCompactionReport, DurableAuditReplayQuery,
    DurableAuditReplayRecord, DurableAuditReplayResult, DurableAuditReplayWindow,
    DurableAuditRetentionPolicy, DurableAuditSinkReport, DurableAuditSinkResult,
    DurableAuditWalSegmentArchiveProof, DurableAuditWalSink, append_record, compact_records,
...
impl DurableAuditWalSink for FileDurableAuditWalSink {
    ...
    {
        append_record(&self.path, record.into())
    }
}
