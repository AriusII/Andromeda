//! CLI command dispatcher and routing.
...
pub use protocol::run_protocol_smoke;
pub use recovery::run_recovery_inspect;
pub use vertical::{print_help, run_vertical_demo, run_vertical_v0_demo};
