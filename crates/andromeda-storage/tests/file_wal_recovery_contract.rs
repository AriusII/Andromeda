...
#[path = "file_wal_recovery_contract/chain_breaks.rs"]
mod chain_breaks;
#[path = "file_wal_recovery_contract/report_partitioning.rs"]
mod report_partitioning;
#[path = "file_wal_recovery_contract/support.rs"]
mod support;
#[path = "file_wal_recovery_contract/tail_boundaries.rs"]
mod tail_boundaries;
#[path = "file_wal_recovery_contract/transaction_visibility.rs"]
