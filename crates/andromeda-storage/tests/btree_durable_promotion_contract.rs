//! Durable B-Tree storage-boundary promotion contract tests.
//!
//! Recovery-owned WAL replay coverage lives in `andromeda-recovery`. Storage
//! keeps the local invariant that logical in-memory B-Tree operations do not
//! imply page-backed durable mutation promotion.
