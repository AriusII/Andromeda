...
fn sample_extent(extent_id: u64, first_page: u64, page_count: u32) -> crate::ExtentDescriptor {
    crate::ExtentDescriptor {
        ...
        state: crate::ExtentState::PublishedCold,
...
) -> crate::WalSegmentDescriptor {
    crate::WalSegmentDescriptor {
        format_version: 1,
        segment_id,
        first_lsn: crate::Lsn::new(first_lsn),
        last_lsn: crate::Lsn::new(last_lsn),
        base_previous_lsn: base_previous_lsn.map(crate::Lsn::new),
        record_count: (last_lsn - first_lsn + 1) as usize,
    }
}

fn sample_manifest() -> crate::backup::BackupManifest {
    crate::backup::BackupManifest {
        ...
        snapshot: crate::ColdSnapshotBoundary {
            ...
            base_checkpoint_lsn: crate::Lsn::new(100),
            required_wal_start_lsn: crate::Lsn::new(101),
        },
        wal_archive: WalArchiveRange::new(crate::Lsn::new(101), crate::Lsn::new(200)),
        manifest_crc: 999,
    }
}
...
fn backup_execution_plan_validates_manifest() {
    ...
    let plan = BackupExecutionPlan {
        ...
        extent_copy_plan: vec![ExtentCopyTask {
            ...
            source_tier: crate::StorageTier::ColdStore,
            byte_count: 64 * 1024,
        }],
