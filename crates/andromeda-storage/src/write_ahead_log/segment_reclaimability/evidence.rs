...
///
/// Capturing the candidate LSN range and all retention boundaries in one value
/// makes the evaluation deterministic and audit-friendly.
...
impl ReclaimabilityEvidence {
    ...
    ///
    /// Precedence is part of the observable policy:
    /// 1. recovery safety
