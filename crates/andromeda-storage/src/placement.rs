...
mod tests {
    use super::*;
    use crate::{
        AllocationId, ExtentId, HotColdIoThresholds, IoPathBudget, IoPathClass, IoUseClass, Lsn,
        ObjectId, PageId, PageSize, SegmentDescriptor, SegmentHeader, SegmentId, SegmentMutation,
