...
fn make_test_manifest() -> crate::backup::BackupManifest {
    crate::backup::BackupManifest {
        ...
        snapshot: ColdSnapshotBoundary {
            ...
            base_checkpoint_lsn: crate::Lsn::new(1000),
            required_wal_start_lsn: crate::Lsn::new(1001),
        },
        wal_archive: WalArchiveRange::new(crate::Lsn::new(1001), crate::Lsn::new(2000)),
        manifest_crc: 1234,
    }
}
...
fn validate_restore_prerequisites_accepts_valid_manifest() {
    ...
    let pitr_lsn = crate::Lsn::new(1500);
...
fn validate_restore_prerequisites_rejects_pitr_before_required_wal_start() {
    ...
    manifest.snapshot.required_wal_start_lsn = crate::Lsn::new(1005);
    manifest.wal_archive = WalArchiveRange::new(crate::Lsn::new(900), crate::Lsn::new(2000));

    let err = validate_restore_prerequisites(&manifest, crate::Lsn::new(1002))
...
fn validate_restore_prerequisites_rejects_pitr_below_range() {
    let manifest = make_test_manifest();
    let pitr_lsn = crate::Lsn::new(999);
...
fn validate_restore_prerequisites_rejects_pitr_above_range() {
    let manifest = make_test_manifest();
    let pitr_lsn = crate::Lsn::new(2001);
...
fn plan_replay_segments_skips_wal_for_snapshot_base_target() {
    let manifest = make_test_manifest();
    let pitr_lsn = crate::Lsn::new(1000);
