...
use crate::heap_redo::HeapRowRedoPayloadV1;
...
/// binding prevents typed row-domain redo from being accepted as anonymous heap
/// bytes by publication gates.
...
///
/// The template intentionally omits `resulting_page_lsn`: only the WAL
