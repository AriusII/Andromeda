...
pub(super) struct ResultStreamMetricsInner {
...
impl ResultStreamMetricsInner {
    ...
    pub(super) fn total_rows_pushed(&self) -> u64 {
    ...
    pub(super) fn snapshot(&self) -> ResultStreamMetrics {
        ResultStreamMetrics {
